...
function providerSandbox(bundle: ProjectBundle | null, run: Run): string {
  ...
  return provider?.kind === "codex-local" || provider?.kind === "claude-local" || provider?.kind === "opencode-local" || provider?.kind === "antigravity-local" || provider?.kind === "grok-local" || provider?.kind === "kimi-local"
