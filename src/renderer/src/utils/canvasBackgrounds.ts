...
export const canvasBackgroundOptions: CanvasBackgroundOption[] = [
  {
    value: "neutral-gray",
    label: t("Neutral gray"),
    description: t("Balanced default for both light and dark themes."),
    swatch: "#7a858c",
  ...
  },
  {
    value: "graphite",
    label: t("Graphite"),
    description: t("Quiet, denser gray with stronger contrast."),
    swatch: "#525b63",
  ...
  },
  {
    value: "cool-mist",
    label: t("Cool mist"),
    description: t("Soft blue-gray for a lighter planning surface."),
    swatch: "#8aa7b3",
  ...
  },
  {
    value: "soft-blue",
    label: t("Soft blue"),
    description: t("Subtle blue canvas without turning the app monochrome."),
    swatch: "#7897c7",
  ...
  },
  {
    value: "warm-paper",
    label: t("Warm paper"),
    description: t("A warmer surface for notes and product planning."),
    swatch: "#b2a17e",
  ...
  },
  {
    value: "deep-slate",
    label: t("Deep slate"),
    description: t("Darker canvas for focused graph work."),
    swatch: "#33424b",
