...
export const providerKindSchema = z.enum(["openai-compatible", "anthropic-compatible", "offline-manual", "codex-local", "claude-local", "opencode-local", "antigravity-local"]);
...
export const runSchema = z.object({
  ...
  mcp: z.object({
    ...
    continuation: z.object({
      ...
      providerKind: z.enum(["codex-local", "claude-local", "opencode-local", "antigravity-local", "api"]),
...
export const researchChatMessageSchema = z.object({
  ...
  mcpApprovalRequest: z.object({
    ...
    providerContinuation: z.object({
      transport: z.enum(["anthropic", "openai-chat", "openai-responses", "codex-local", "claude-local", "opencode-local", "antigravity-local"]),
